...
<head>
    ...
    <title>Cetak Batch Surat Jalan Kurir</title>
    <style>
        body {
            ...
            /* Diberi warna latar sedikit agar kartu terlihat di layar besar */
        }
        ...
        @media screen and (max-width: 768px) {
            ...
            table {
                min-width: 500px;
                /* Mencegah tabel menyusut hingga hancur */
            }
...
<body>
    ...
    <div style="text-align: center;">
        <button onclick="window.print()" class="btn-print">🖨️ Cetak Semua Surat Jalan ({{ count($sales) }})</button>
    </div>
    ...
    <div class="invoice-card">
        ...
        {{-- Menambahkan pembungkus responsive --}}

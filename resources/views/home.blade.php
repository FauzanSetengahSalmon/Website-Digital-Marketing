...
<style>
    ...
    /* 🌟 PERBAIKAN STYLE: Menambahkan desain kotak deskripsi minimalis */
    .desc-container {
        background: #fdfdfd;
    ...
    <section class="hero-section shadow-sm">
        <div class="hero-content">
            ...
            <div class="d-flex gap-3">
                <a href="{{ route('customer.katalog') }}" class="btn-green">
                    <i class="bi bi-bag-check"></i>
                    Belanja Sekarang
                </a>

                <a href="{{ route('about') }}" class="btn-outline-green">
                    Tentang Kami
                </a>
            </div>
        </div>
                ...
                <div class="product-card border-0 shadow-sm">
                    ...
                    <div class="p-3 d-flex flex-column flex-grow-1">
                        ...
                        <div class="d-flex gap-2 mt-2">
                            ...
                            @else
                            <button class="btn-buy-now w-100" disabled>
                                Habis
                            </button>
        ...
        <div class="container">
            <div class="cta-section text-center p-5 shadow">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    ...
                    <a href="{{ route('about') }}" class="btn btn-outline-success px-4 py-2 fw-bold"

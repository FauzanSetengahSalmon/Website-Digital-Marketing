                    ...
                    <div class="row g-4 align-items-start">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                                ...
                                <span class="badge bg-success-subtle text-success border border-success rounded-pill px-3 py-1 fw-bold"><i class="bi bi-check-circle-fill me-1"></i> DITANGGAPI</span>
                                @endif
                                <span class="text-muted small font-monospace ms-sm-2">#INV-{{ str_pad($report->order_id, 5, '0', STR_PAD_LEFT) }}</span>
                            </div>
                            ...
                            <div class="p-3 bg-light rounded-3 text-secondary small border-start border-4 border-secondary mb-3 text-break">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="p-3 bg-success bg-opacity-10 border border-success-subtle rounded-3">
                                    ...
                                    <p class="small text-dark mb-2 lh-base text-break">"{!! nl2br(e($report->tanggapan_kwt)) !!}"</p>
                        ...
                        <div class="col-12 col-md-4 border-start ps-3 ps-md-4 mt-4 mt-md-0 align-self-center">

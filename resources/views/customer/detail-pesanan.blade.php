...
@section('title','Detail Pesanan - Tani Cibiru')
            ...
            <div class="summary-card">
                ...
                <div class="card-modern mb-4 border-0 shadow-sm bg-white" style="border-radius: 22px;">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="fw-bold m-0 text-success" style="font-size: 1.05rem;">Pesanan Telah Selesai</h6>
                    </div>

                    @if($order->bukti_sampai)
                    <div class="text-center mb-3">
                        <p class="text-muted small mb-2 text-start">Pratinjau Bukti Pengiriman Kurir:</p>
                        <img src="{{ asset('storage/' . $order->bukti_sampai) }}" class="img-fluid rounded-4 border shadow-sm w-100" style="max-height: 250px; object-fit: cover;">
                    </div>
                    @endif
                    <p class="text-muted small mb-0">Terima kasih! Pesanan Anda telah selesai dikonfirmasi dan diterima dengan baik.</p>
                </div>
                @endif
